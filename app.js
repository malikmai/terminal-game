...
console.log(`Well ${username}, here's the jazz. Its been a bad winter and has been snowing all year! We need you to get this place up and running in 30 DAYS!`)
console.log( ); // added for visibility
console.log(`I'll need you to use your cunning and wit to manage us out of this pickle. You can buy some upgrades as needed but we're dirt broke right now and alls we got is this here shovel.`)
console.log(); // added for visibility
console.log(`Anywho! Your goal is to get us a big ol' truck and some new building upgrades but its gonna run us $${END_GOAL}!`)
console.log( ); // added for visibility
console.log()
...
function generateRandomEarnings(level, upgradeLevels) {
    switch (level) {
        ...
        case 2:
            const minEarningsB = BASE_DAILY_EARNINGS['B'] + (upgradeLevels['B'] - 1) * 250; // Adjust minimum earnings based on upgrade level
        ...
        case 3:
            const minEarningsC = BASE_DAILY_EARNINGS['C'] + (upgradeLevels['C'] - 1) * 500; // Adjust minimum earnings based on upgrade level
        ...
        case 4:
            const multiplierCLevel4 = UPGRADE_MULTIPLIERS['C'][upgradeLevels['C'] - 1]; // Get the multiplier for option C
